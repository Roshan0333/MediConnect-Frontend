...
function AppointmentBooking() {
    ...
    let { DoctorName, DoctorId,DoctorSpecialization, AppointmentDate, AppointmentTime, experience, specialization, date, fee, doctorPhoto } = location.state;
    ...
    let Cancel = async () => {
        try{
            ...
            Navigate("/AppointmentBooking", 
                {state:{id:DoctorId, doctorName:DoctorName, specialization, experience, date:date, fee: fee, doctorPhoto: doctorPhoto},},
                {replace: true}    
            )
        }
        catch(err){
